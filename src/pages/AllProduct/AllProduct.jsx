    ...
    <div className="mb-16 pt-24 container mx-auto">
      ...
      <div className="flex justify-between items-center my-10">
        ...
        <form onSubmit={handleSearch} className=" relative">
          <input
            className="p-3 w-75 border border-primary/30 pl-8 outline-none focus:border-primary rounded-2xl"
            type="text"
            placeholder="Search..."
            name="search"
          />
          <FaSearch className="text-gray-500 font-normal absolute top-4.5 left-2" />
        </form>
      </div>
